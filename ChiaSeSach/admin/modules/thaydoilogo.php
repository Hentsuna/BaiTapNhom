...
if(isset($_POST['check'])){
    if($_FILES['imgInp']['error'] == 0)
    {
        ...
        if (in_array($imageFileType,$allowtypes ))
        {
            ...
            $pathav =  $domain."/images/logo/".$_FILES['imgInp']['name'];
            $sql = "UPDATE image_web SET duong_dan='$pathav' WHERE ten = 'logo'";
...
<div style="background: #fff; padding: 20px; margin: auto; width: 350px; margin-top: 60px; border-radius: 3px; box-shadow: 0px 0px 3px 3px #95999c; ">
    ...
    <form method="post" action="#"  enctype="multipart/form-data">
        ...
        <div class="form-group">
            <?php
            $getFavicon = mysqli_fetch_assoc(mysqli_query($conn, "SELECT duong_dan FROM image__web where ten = 'logo'"))['duong_dan'];
            ?>
